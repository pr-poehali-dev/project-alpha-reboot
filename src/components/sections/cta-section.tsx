...
export function CtaSection() {
  return (
    <section id="cta" className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-br from-[#0a1f55]/30 to-gray-950/30">
      <div className="container px-6 md:px-8">
        <ScrollReveal>
          <div className="flex flex-col items-center justify-center space-y-6 text-center">
            <div className="space-y-4">
              <AnimatedText
                text="Готов стать последним выжившим?"
                variant="heading"
                className="text-3xl font-heading font-bold tracking-tighter sm:text-5xl gradient-text"
                animation="wave"
              />
              <AnimatedText
                text="Присоединяйся к тысячам игроков прямо сейчас. Бесплатно скачай и начни свой путь к победе."
                variant="paragraph"
            ...
            >
              ...
              >
                <OutlineButton size="lg" className="bg-background w-full h-full border-0 px-8 py-3" asChild>
                  <a href="#features">Особенности игры</a>
                </OutlineButton>
              </AnimatedGradientBorder>
            </motion.div>
          </div>
